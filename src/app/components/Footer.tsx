export default function Footer() {
  return (
    <div className="flex h-auto md:h-[130px] items-center justify-between w-full px-4 md:px-20 py-6 md:py-[32px] z-10 flex-col md:flex-row gap-6 md:gap-0 border-t border-[rgba(255,255,255,0.05)] mt-16 md:mt-0">
